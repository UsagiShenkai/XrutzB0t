...
module.exports = Xrutz = async (Xrutz, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Xrutz.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "PILIH DISINI","footerText": "© ʏᴜᴍᴇ-ʙᴏᴛ","listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        const replyf = (teks) => {
            Xrutz.sendMessage(from, teks, text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ʏᴜᴍᴇ sᴇʟғʙᴏᴛ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/masrell.jpg'),sourceUrl:"https://wa.me/6285717026352?text=Assalamualaikum"}}})        
		}
...
{buttonId: `${prefix}storegame`,buttonText:{displayText: 'STORE GAME 💎'},type:1}
               ...
               prep = await Xrutz.prepareMessageFromContent(from,{buttonsMessage},{quoted: fakekontak, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ʏᴜᴍᴇ-sᴇʟғʙᴏᴛ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/masrell.jpg'),sourceUrl:"https://wa.me/6285717026352?text=Assalamualaikum"}}})
               Xrutz.relayWAMessage(prep)
               break
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              Xrutz.sendMessage('6285717026352@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
